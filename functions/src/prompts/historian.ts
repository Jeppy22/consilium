...
export const VALIDATE_FHIR_BUNDLE_TOOL = {
  name: 'validate_fhir_bundle',
  description:
    'Validates a proposed FHIR Bundle against the Consilium-shaped schema. ' +
  ...
  input_schema: {
    ...
    properties: {
      bundle: {
        type: 'object',
        description:
          'The proposed FHIR Bundle. Must have resourceType: "Bundle", type: "collection", and an entry array of { resource } items.',
      },
    },
    required: ['bundle'],
  },
